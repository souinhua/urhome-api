...
App::singleton('oauth2', function() {
    ...
    $storage = new OAuth2\Storage\Pdo(array('dsn' => 'mysql:dbname=urhome-api;host=urhome-api.mysql.eu1.frbit.com', 'username' => 'urhome-apiurhome-api', 'password' => 'q4xnx3B5OkTNhRN6'));
